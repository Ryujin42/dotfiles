...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("pactl set-sink-mute 0 toggle") end,
        { description = "mute sound", group = "custom"}),

    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer set Master 5-") end,
        { description = "lower volume by 5%", group = "custom"}),

    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer set Master 5+") end,
        { description = "raise volume by 5%", group = "custom"}),
        
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("brightnessctl s 10%-") end,
        { description = "lower brightness by 10%", group = "custom"}),
...
-- change the border color of the client when focused
